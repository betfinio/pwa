import { useMediaQuery } from '@betfinio/components';
import {
	Button,
	Dialog,
	DialogContent,
	...
	if (!isMobile) {
		return (
			<Dialog>
				...
				<DialogContent className="p-4 max-w-[400px] mx-auto">
					<DialogHeader className="text-center! w-full text-lg">
						<DialogTitle>Login or sign up</DialogTitle>
					</DialogHeader>
					<DialogDescription asChild className="text-foreground text-base">
